...
par(mfrow=c(2,2))
plot(my_data$date_time, my_data$Global_active_power, type="l", xlab="", ylab="Global Active Power")
plot(my_data$date_time, my_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(my_data$date_time, my_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()